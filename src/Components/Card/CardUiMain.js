...
const p1=[
    "Protect yourself and others from COVID-19",<br/>,
...
const p2=[
    "Are you infected?",<br/>,
    "Here are some queries about the major symptoms of coronavirus.",<br/>,
...
const p3=[
    "World Live Stats will provides information about coronavirus real time update",<br/>,
